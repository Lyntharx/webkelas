...
const Schedule = () => {
    ...
    piketGroup = [
        ["Abimanyu","Nasira","Zahra","Arief","Karunia","Aulia Suci","Arfan"],
            ["Luqman","Mia","Muza","Salsabila","Talitha","Alda","Arsyana"],
            ["Yufrizal","Rahma","Meilani","Mita","Ikhsan","Nafisa"],
            ["Alif","Firda","Erni","Amelia","Risti","Aulia Az"],
            ["Ahmad","Aura","Feby","Gita","Cahya","Alvina","Sinta"]
    ]
